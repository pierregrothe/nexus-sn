...
async def test_fetch_dependencies_returns_typed_entries() -> None:
    ...
    client.set_dependencies("sn_si", [
        {"Id": "Common A", "orig_string": "sn_a:1.0", "type": "Application",
         "minVersion": "1.0", "source_app_id": "id1", "installed": True,
         "hide_on_ui": False, "status": "Will be Updated",
         "status_value": "will_be_updated", "active": True, "order": 1,
         "link": "", "has_license": False, "is_allowed_install": True},
    ])
